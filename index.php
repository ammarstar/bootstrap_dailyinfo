    ...
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:rgb(67, 147, 12);">
        ...
        <div class="collapse navbar-collapse" id="ikonkecil">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a href="teknologi.php" class="nav-link">Teknologi</a>
            </li>
            <li class="nav-item">
              <a href="gadget.php" class="nav-link">Gadget</a>
            </li>
          </ul>

        <form class="form-inline" method="post">
          <input type="search" class="form-control mr-sm-2" name="" placeholder="search">
          <button type="submit" class="btn btn-outline-info mr-sm-3" name="button">search</button>
        </form>
        <a href="multiuser.php">
        <img src="images/login-gambar.png" alt="" width="42px" style="margin: 1px;padding: 0px ">
        </a>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-9">
            <?php
            $query=mysqli_query($link, "SELECT * FROM berita");
          ...
          <div class="col-md-3">
            ...
            while ($output=mysqli_fetch_assoc($query)) {
              $tampil=substr($output['judul'], 0, 30)."......." . "<br>";
              ?>
              <a href="content.php?read=<?php echo $output['id']; ?>">
                <?php echo $tampil; ?>
              </a>
              <?php
            }
